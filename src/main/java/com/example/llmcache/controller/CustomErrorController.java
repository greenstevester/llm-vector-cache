...
public class CustomErrorController implements ErrorController {
    ...
    private String getErrorMessage(int statusCode, String originalMessage) {
        return switch (statusCode) {
            case 404 -> "The requested resource was not found. Available endpoints: /api/llm/generate, /api/llm/health, /api/llm/cache/stats";
            ...
            default -> originalMessage != null ? originalMessage : "An error occurred while processing your request.";
        };
    }
    ...
    public ResponseEntity<Map<String, Object>> home() {
        ...
        documentation.put("api_docs", "POST to /api/llm/generate with {'prompt': 'your question', 'options': {'model': 'gpt-3.5-turbo'}}");
